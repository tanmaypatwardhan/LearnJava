...
public class friday {
  public static void main(String[] args) throws IOException {
    ...
    System.out.println(freq_of_thirteenths[6] + " " + freq_of_thirteenths[0] + " " + freq_of_thirteenths[1] + " " + freq_of_thirteenths[2] + " " + freq_of_thirteenths[3] + " " + freq_of_thirteenths[4] + " " + freq_of_thirteenths[5]);
  }
}
